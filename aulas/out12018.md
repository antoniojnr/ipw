...
4. Neste momento, você precisará configurar o acesso ao banco de dados. Usaremos o banco de dados PostgreSQL e no arquivo `config/config.json` você irá inserir as configurações para acessar a sua base de dados. Antes de inserir as configurações, certifique-se de ter seguido os passos listados [aqui]()
